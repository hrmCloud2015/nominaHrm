...
class NominaE2 extends TableGateway
{
    ...
    public function actFechaEmail($timeStamp,$idEmp){
        
        //$this->update(['fechaEmail'=>$timeStamp], ['idEmp'=>$idEmp]);
        //$this->adapter->query("update `n_nomina_e` SET fechaEmail = NOW( ) WHERE idEmp IN ( ? ) ", $idEmps);
