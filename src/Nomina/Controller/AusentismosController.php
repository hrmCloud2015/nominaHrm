...
class AusentismosController extends AbstractActionController
{
    ...
    private $ttab = ",id, Fecha,Empleado,Cargo,Centro de costos,Tipo,Desde, Hasta,Horas, Pdf  ,Editar,Eliminar"; // Titulo de las columnas de la tabla
      ...
      if ($id > 0) // Cuando ya hay un registro asociado
         {
            ...
            $form->get("numero")->setAttribute("value",$datos['horas']);             
         }            
         return new ViewModel($valores);
      }
