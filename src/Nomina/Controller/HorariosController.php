...
class TurnosController extends AbstractActionController
{
    ...
    private $tlis = "Turnos de empleados"; // Titulo listado
    private $tfor = "Actualización de tipos de Turnos"; // Titulo formulario
    ...
    public function listAction()
    {
        ...
        (
            ...
            "datos"     =>  $d->getGeneral("select a.*, ( select count(b.id) from n_Turnos_c b where b.idHor = a.id) as num 
                            from n_Turnos a"),            
            "ttablas"   =>  $this->ttab,
      ...
      if($this->getRequest()->isPost()) // Actualizar 
      {
        ...
        {      
            ...
            try {
                ...
                $d->modGeneralId("insert into n_Turnos_c (idHor,idCon,Horas, idUsu)
      ...
      if ($id > 0)
         {
            ...
            try {
                ...
                $dat = $d->getGeneral1("Select * from n_Turnos_c where id=".$id);
                $d->modGeneral("delete from n_Turnos_c where id=".$id);
